...
if [ -d /proc/sys/walt ]; then
	...
	echo "UnityMain,libunity.so,libil2cpp.so,com.miHoYo.,com.pubg.imobile,com.pubg.,com.activision.,com.mobilechess.gp,com.mobile.legends,com.carxtech.sr,com.activision.callofduty.shooter" > /proc/sys/walt/sched_lib_name
...
echo 0-6 > /dev/cpuset/systemui/cpus
echo 0-6 > /dev/cpuset/foreground_window/cpus
echo 0-4 > /dev/cpuset/dex2oat/cpus
