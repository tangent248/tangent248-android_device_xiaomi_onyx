...
if [ -d /proc/sys/walt ]; then
	...
	echo "UnityMain,libunity.so,libil2cpp.so,com.miHoYo.,com.pubg.imobile,com.pubg.,com.activision.,com.mobilechess.gp,com.mobile.legends,com.carxtech.sr" > /proc/sys/walt/sched_lib_name
